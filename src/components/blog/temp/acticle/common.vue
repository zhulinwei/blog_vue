  ...
  <div class="l-acticle-common-wrapper" :acticle="acticles">
    ...
    <div class="l-acticle-common">
      <ul v-if="acticles.length">
        <li v-for="acticle in acticles" class="l-acticle-common-item"  @click="detail(acticle)">
          <router-link :to="`/blog/acticle/${acticle._id}`"  @click="detail(acticle)" :acticle="acticle">
